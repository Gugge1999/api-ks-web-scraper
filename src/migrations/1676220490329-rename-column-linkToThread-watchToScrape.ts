...
export class renameColumnLinkToThreadToWatchToScrape1676220490329
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "watch" ADD "watchToScrape" character varying NOT NULL`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "watch" ADD "linkToThread" character varying NOT NULL`
    );
  }
}
